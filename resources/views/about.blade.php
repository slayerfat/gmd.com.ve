...
@section('content')
  <section id="about-us">
    <div class="container">
      ...
      <div class="team">
        <div class="center wow fadeInDown">
          <h2>El equipo de GMD</h2>
          <p class="lead">
            El equipo de GMD esta conformado por talento humano altamente calificado.
          </p>
        </div>
            ...
            <div class="single-profile-top wow fadeInDown"
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h4>Gilberto Martínez Díaz</h4>
                  <h5>Fundador</h5>
                  <ul class="tag clearfix">
                    <li class="btn"><a href="#">Tip 1</a></li>
                    <li class="btn"><a href="#">Tip 2</a></li>
                    <li class="btn"><a href="#">Tip 3</a></li>
                    <li class="btn"><a href="#">Tip 4</a></li>
                  </ul>
